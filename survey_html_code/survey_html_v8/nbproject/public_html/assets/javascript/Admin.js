...
Admin.prototype.readCookie=function(){
    ...
    var i = 0;
    var allcookies = [
        {id: 1, name:'Homer', email:'homer@simp.com', password:'Homer123', votes: [1,1,1]},
        {id: 2, name:'Marge', email:'marge@simp.com', password:'Marge123', votes: [2,2,2]},
        {id: 3, name:'Lisa', email:'lisa@simp.com', password:'Lisa123', votes: [0,0,0]},
        {id: 4, name:'Bart', email:'bart@simp.com', password:'Bart123', votes: [1,2,0]},
        {id: 5, name:'Ned', email:'ned@flanders.com', password:'Flanders123', votes: [0,1,2]}
    ];
    ...
    while(i < stop){    
        ...
        this.usrArr[i].setNumRec(allcookies[i].id);  // Set id in User object 
